...
extern double significand _PARAMS((double));
...
extern double nan _PARAMS((const char *tagp));
...
extern float significandf _PARAMS((float));
#ifndef _REENT_ONLY
...
extern float nanf _PARAMS((const char *tagp));
