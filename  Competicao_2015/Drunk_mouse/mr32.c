...
#elif(ROBOT == 3)
int SERVO_WIDTH_MIN = 510;	// 0.535 ms 
int SERVO_WIDTH_MAX = 2310; // 2.365 ms
#elif(ROBOT == 5)
...
#elif(ROBOT == 11)
int SERVO_WIDTH_MIN = 415;	// 0.595 ms 
...
// ***************************************************************************
#define DIM_BAT_ARRAY	64		// Dimension of the battery voltage array
...
void readAnalogSensors(void)
{
	...
	{	
		...
		IFS1bits.AD1IF = 0;
		if(i != 5)	// do not write battery raw value
